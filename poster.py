...
ANALYSIS_KEYWORDS = [
    'твоё мнение', 'твое мнение', 'выскажи своё мнение', 'выскажи мнение',
    'что думаешь', 'как считаешь', 'дай оценку', 'расскажи подробно',
    'сделай анализ', 'проанализируй', 'оцени ситуацию', 'как тебе',
    'поделись мыслями', 'что скажешь', 'твой взгляд', 'твоя точка зрения',
    'дай развёрнутый ответ', 'объясни подробно', 'расскажи что знаешь',
    'напиши разбор', 'сделай обзор'
]
