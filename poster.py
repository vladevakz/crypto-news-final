...
# --- Фразы для unrestricted / restricted ---
UNRESTRICT_PHRASES = [
...
# -------------------- Ответы на сообщения (MUTE, UNRESTRICTED) --------------------
async def reply_to_messages():
    ...
    for update in updates:
        ...
        # --- Переключение restricted/unrestricted ---
        ...
        # --- Формируем system_prompt в зависимости от режима ---
